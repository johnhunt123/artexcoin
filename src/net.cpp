...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ArtexCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"162.243.85.154", "162.243.85.154"},
	{"162.243.99.178", "162.243.99.178"},
	{"seed3.cryptolife.net", "seed3.cryptolife.net"},
	{"electrum3.cryptolife.net", "electrum3.cryptolife.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ArtexCoin is probably already running."), addrBind.ToString().c_str());
        else
